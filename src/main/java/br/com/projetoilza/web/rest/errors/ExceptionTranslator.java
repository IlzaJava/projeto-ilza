...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.com.projetoilza.service.EmailAlreadyUsedException ||
            ex instanceof br.com.projetoilza.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof br.com.projetoilza.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "br.com.projetoilza");
    }
}
